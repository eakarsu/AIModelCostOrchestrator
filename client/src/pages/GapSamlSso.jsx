...
export default function GapSamlSso() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-saml-sso', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Saml Sso</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>SAML/SSO enterprise auth</p>
