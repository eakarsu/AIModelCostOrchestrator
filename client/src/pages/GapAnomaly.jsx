...
// Anomaly
// Anomaly investigation runbook UI

export default function GapAnomaly() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-anomaly', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Anomaly</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Anomaly investigation runbook UI</p>
