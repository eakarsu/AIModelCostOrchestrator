...
// Autonomous
// Autonomous budget governor predicting overages and auto-throttling
...
export default function GapAutonomous() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Autonomous budget governor predicting overages and auto-throttling</p>
