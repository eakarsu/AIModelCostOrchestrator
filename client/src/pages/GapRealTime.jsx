...
// Real Time
// Real-time cost optimization recommending prompt rewrites and caching
...
export default function GapRealTime() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Real-time cost optimization recommending prompt rewrites and caching</p>
