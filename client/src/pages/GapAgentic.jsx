...
// Agentic
// Agentic model selection routing per-request to optimal model with fallback
...
export default function GapAgentic() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Agentic model selection routing per-request to optimal model with fallback</p>
